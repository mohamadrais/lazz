                        ...
                        <div class="block">
                            ...
                            <div class="panel-body m-b-20">
                                ...
                                <div class="form-group">
                                    <label class="col-12 control-label">Add Users</label>
                                    <div class="col-12">
                                        <input type="radio" name="user" value="agent">&emsp;Lazz Kurma/Asli/Choco&emsp;&emsp;
                                        <input type="radio" name="user" value="stockist">&emsp;Lazzcafe Without Milk&emsp;&emsp;
                                        <input type="radio" name="user" value="stockist">&emsp;Lazzcafe With Milk&emsp;&emsp;
                                    </div>
                                </div>
                                    
                                <div class="form-group">
                                    <label class="col-6 control-label">Minimum Orders (Carton)</label>
                                    <div class="col-6">
                                        <input type="number" class="form-control" placeholder="Enter Minimum Orders">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-6 control-label">User Price</label>
                                    <div class="input-group col-6">
                                        <span class="input-group-addon">
                                            <span class="fa fa-usd"></span>
                                        </span>
                                        <input type="number" class="form-control" placeholder="Enter Price for This User">
                                    </div>
                                </div>
