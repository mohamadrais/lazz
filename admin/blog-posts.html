        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="block">
                        <input class="input-group form-control form-group" placeholder="Enter title here"></input>
                        <div class="form-group">
                            <textarea class="summernote"></textarea>
                        </div>
                        <button type="button" class="btn btn-primary pull-right btn-success mb-control" data-box="#message-box-success">Post</button>
                        <!--button type="button" class="btn btn-primary pull-right btn-success mb-control" data-box="#message-box-fail">Submit</button-->
                    </div>
                                ...
                                <table class="table table-bordered table-striped table-actions">
                                    ...
                                    <tbody>
                                        <tr id="trow_1">
                                            ...
                                            <td>
                                                <strong>MESTI CUBA- Green Tea Latte Versi Slim dan Kulit Cerah</strong>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-danger btn-rounded btn-sm" onClick="delete_row('trow_1');">
                                        ...
                                        <tr id="trow_2">
                                            ...
                                            <td>
                                                <strong>Rupanya Halba Bukan Sekadar Tambah Susu Badan, Malah Boleh Cantikkan Payudara
                                                    Juga!
                                                </strong>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-danger btn-rounded btn-sm" onClick="delete_row('trow_2');">
                                                    <span class="fa fa-times"></span>
                                                </button>
                                            </td>
                                        </tr>
                                        <tr id="trow_3">
                                            ...
                                            <td>
                                                <strong>Ayah, ayah tolong jaga ibu tau, Jangan bagi ibu makan benda yang manis-manis…</strong>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-danger btn-rounded btn-sm" onClick="delete_row('trow_3');">
                                                    <span class="fa fa-times"></span>
                                                </button>
                                            </td>
                                        </tr>
